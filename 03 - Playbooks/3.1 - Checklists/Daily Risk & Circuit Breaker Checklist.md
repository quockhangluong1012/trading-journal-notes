...
> - **≤ 0.5% tài khoản / lệnh.** Vượt 0.5% là VI PHẠM — xem [[07 - Mistake - Risk more than 0.5% total account]].
...
- [ ] Đã xác định **Daily Bias** rõ ràng, không mâu thuẫn H1/M15 — xem [[09 - Mistake - Wrong daily bias]]
...
- [ ] Chỉ trade thị trường trong kế hoạch (ưu tiên **NQ1/NDX**); không "đi lạc" sang EU/GU/Gold ngoài plan — xem [[01 - Mistake - Emotional revenge trade]]
...
> - [ ] Có **Liquidity Sweep** trước entry — xem [[02 - Mistake - Enter before liquidity sweep]]
> - [ ] Có **Displacement** + **MSS** hợp lệ — xem [[06 - Mistake - Not Have Market Structure Shift]]
> - [ ] MSS nằm **trong vùng POI** (không entry khi MSS ngoài POI) — xem [[03 - Mistake - Entry When MSS not in POI Zone]]
> - [ ] Entry trong FVG / OB / PD Array hợp lệ
> - [ ] SL ngoài vùng invalidation; **risk ≤ 0.5%**
> - [ ] **RR tối thiểu ≥ 2.0** — xem [[05 - Mistake - Not enough RR]]
...
> - [ ] Cảm thấy muốn "gỡ" / cay cú / vào lệnh không có setup → **đứng dậy 15 phút**, xem [[01 - Mistake - Emotional revenge trade]]
