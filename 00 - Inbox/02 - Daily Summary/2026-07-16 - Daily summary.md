...
4. **Tạo note [[Mistake - Sai lệch dữ liệu nhật ký]]** trong `06 - Mistake Database/` — vẫn treo nhiều ngày dù dữ liệu hiện đã sạch; nên có để theo dõi lịch sử lỗi này.
