...
> 1. **[Loop #1 làm sạch — CHƯA làm, đây là ưu tiên số 1 của task sáng nay]** 3 note XAUUSD `04 - Backtesting/2026-07-14/` **vẫn còn `symbol:` RỖNG ở cả 3** (`01`, `02`, `03`) — chưa được rà và điền lại như task yêu cầu; và **[[12 - Mistake - Log Data Mismatch - Backtest]] vẫn CHƯA được tạo** trong `06 - Mistake Database/`. Dữ liệu bẩn chưa được sửa nghĩa là 3/17 mẫu vẫn không đáng tin — đúng rủi ro "garbage in, garbage out" đã cảnh báo 2 ngày liền.
